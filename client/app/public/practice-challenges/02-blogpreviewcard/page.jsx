...
const page = () => {
  return (
    <div className="primary-yellow mx-[-25px] py-24 ">
      <div className="box-shadow mx-auto flex  w-[384px] flex-col gap-6 rounded-2xl border border-black bg-white p-6 text-black ">
        <Image
